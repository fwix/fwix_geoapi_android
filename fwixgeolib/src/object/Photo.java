...
public class Photo extends Content {
  ...
  public Photo(Parcel i) {
    super(i);
    thumbnail = i.readString();
  }

  public void writeToParcel(Parcel o, int f) {
    super.writeToParcel(o,f);
    o.writeString(thumbnail);
  }

  public static final Parcelable.Creator<Photo> CREATOR =
      new Parcelable.Creator<Photo>() {
    public Photo createFromParcel(Parcel i) { return new Photo(i); }
    public Photo[] newArray(int s) { return new Photo[s]; }
  };
}
