...
public class Range implements Parcelable {
  ...
  public Range(Parcel i) {
    start = new Date(i.readLong());
    end = new Date(i.readLong());
  }

  public void writeToParcel(Parcel o, int f) {
    o.writeLong(start.getTime());
    o.writeLong(end.getTime());
  }

  public static final Parcelable.Creator<Range> CREATOR =
      new Parcelable.Creator<Range>() {
    public Range createFromParcel(Parcel i) { return new Range(i); }
    public Range[] newArray(int s) { return new Range[s]; }
  };
